...
namespace sbp{
  ...
  inline PetscErrorCode advection_apply_l(const SbpDerivative& D1, const SbpInvQuad& HI, VelocityFunction&& a, const PetscScalar *const *const src, PetscScalar *const *const dst, const PetscInt N, const PetscScalar hi, const PetscInt n_closures)
  {
    int i;
  ...
  template <class SbpDerivative, class SbpInvQuad, typename VelocityFunction>
  inline PetscErrorCode advection_apply_r(const SbpDerivative& D1, const SbpInvQuad& HI, VelocityFunction&& a, const PetscScalar *const *const src, PetscScalar *const *const dst, const PetscInt N, const PetscScalar hi, const PetscInt n_closures)
  {
    int i;
  ...
  inline PetscErrorCode advection_apply_c(const SbpDerivative& D1, VelocityFunction&& a, const PetscScalar *const *const src, PetscScalar *const *const dst, PetscInt i_start, PetscInt i_end, const PetscInt N, const PetscScalar hi)
  {
    int i;
  ...
  template <class SbpDerivative, class SbpInvQuad, typename VelocityFunction>
  inline PetscErrorCode advection_apply_1p(const SbpDerivative& D1, const SbpInvQuad& HI, VelocityFunction&& a, const PetscScalar *const *const src, PetscScalar *const *const dst, PetscInt i_start, PetscInt i_end, const PetscInt N, const PetscScalar hi)
  {
  ...
  **/
  template <class SbpDerivative, class SbpInvQuad, typename VelocityFunction>
  inline PetscErrorCode advection_apply_all(const SbpDerivative& D1, const SbpInvQuad& HI, VelocityFunction&& a, const PetscScalar *const *const src, PetscScalar *const *const dst, PetscInt i_start, PetscInt i_end, const PetscInt N, const PetscScalar hi)
  {
    const auto [iw, n_closures, closure_width] = D1.get_ranges();
  ...
  template <class SbpDerivative, class SbpInvQuad, typename VelocityFunction>
  inline PetscErrorCode advection_apply_inner(const SbpDerivative& D1, const SbpInvQuad& HI, VelocityFunction&& a, const PetscScalar *const *const src, PetscScalar *const *const dst, PetscInt i_start, PetscInt i_end, const PetscInt N, const PetscScalar hi, const PetscInt sw)
  {
    const auto [iw, n_closures, closure_width] = D1.get_ranges();
  ...
  template <class SbpDerivative, class SbpInvQuad, typename VelocityFunction>
  inline PetscErrorCode advection_apply_outer(const SbpDerivative& D1, const SbpInvQuad& HI, VelocityFunction&& a, const PetscScalar *const *const src, PetscScalar *const *const dst, PetscInt i_start, PetscInt i_end, const PetscInt N, const PetscScalar hi, const PetscInt sw)
  {
    if (i_start == 0) 
    {
