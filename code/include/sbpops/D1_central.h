...
namespace sbp {
  ...
  **/
  ...
  public:
    ...
    **/
    inline PetscScalar apply_2D_x_left(PetscScalar ***v, const PetscScalar hix, const PetscInt i, const PetscInt j, const PetscInt comp) const
    {
      PetscScalar u = 0;
      for (PetscInt is = 0; is<closure_width; is++)
      {
    ...
    * Output: derivative v_x[j][i][comp]
    **/
    inline PetscScalar apply_2D_y_left(PetscScalar ***v, const PetscScalar hiy, const PetscInt i, const PetscInt j, const PetscInt comp) const
    {
      PetscScalar u = 0;
      for (PetscInt is = 0; is<closure_width; is++)
      {
    ...
    * Output: derivative v_x[j][i][comp]
    **/
    inline PetscScalar apply_2D_x_interior(PetscScalar ***v, const PetscScalar hix, const PetscInt i, const PetscInt j, const PetscInt comp) const
    {
      PetscScalar u = 0;
      for (PetscInt is = 0; is<interior_width; is++)
      {
        u += static_cast<const Stencils&>(*this).interior_stencil[is]*v[j][i-(interior_width-1)/2+is][comp];
        // printf("v[%d][%d]: %f\n",j,comp,v[j][i-(interior_width-1)/2+is][comp]);
      }
      return hix*u;
    };
    ...
    * Output: derivative v_x[j][i][comp]
    **/
    inline PetscScalar apply_2D_y_interior(PetscScalar ***v, const PetscScalar hiy, const PetscInt i, const PetscInt j, const PetscInt comp) const
    {
      PetscScalar u = 0;
      for (PetscInt is = 0; is<interior_width; is++)
      {
    ...
    * Output: derivative v_x[j][i][comp]
    **/
    inline PetscScalar apply_2D_x_right(PetscScalar ***v, const PetscScalar hix, const PetscInt Nx, const PetscInt i, const PetscInt j, const PetscInt comp) const
    {
      PetscScalar u = 0;
      for (PetscInt is = 0; is < closure_width; is++)
      {
    ...
    * Output: derivative v_x[j][i][comp]
    **/
    inline PetscScalar apply_2D_y_right(PetscScalar ***v, const PetscScalar hiy, const PetscInt Ny, const PetscInt i, const PetscInt j, const PetscInt comp) const
    {
      PetscScalar u = 0;
      for (PetscInt is = 0; is < closure_width; is++)
      {
