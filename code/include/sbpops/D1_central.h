  ...
  **/
  ...
  public:
    ...
    **/
    ...
    // 2D functions
    //=============================================================================
    template <int dim, Region r>
    inline PetscScalar apply(const grid::grid_function_2d<PetscScalar> v, const PetscScalar hi, const PetscInt i, const PetscInt j, const PetscInt comp) const;
    /**
