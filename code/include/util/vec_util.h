...
**/
PetscScalar compute_error(const Vec v1, const Vec v2, const NormType n);
...
template <size_t dim>
PetscScalar error_l2(const Vec v1, const Vec v2, const std::array<PetscScalar,dim>& h) {
  PetscScalar err_l2 = compute_error(v1, v2, NORM_2);
...
PetscScalar error_max(const Vec v1, const Vec v2) {
  return compute_error(v1, v2, NORM_INFINITY);
}
