...
{    
    ...
    {   
        ...
        return grid::partitioned_layout_1d(grid::extents_1d(nlocal,dofs),g2l_offset,sw,nx);
    }
    ...
    {   
        ...
        return grid::partitioned_layout_2d(grid::extents_2d(nxg,nyg,dofs),g2l_offset,sw,nx,ny);
    }
