...
{ 
  ...
  MatCreateShell(PETSC_COMM_WORLD,F_matctx.gridctx.n[0]*Nt*dofs,F_matctx.gridctx.n[0]*Nt*dofs,F_matctx.gridctx.N[0]*Nt*dofs,F_matctx.gridctx.N[0]*Nt*dofs,&F_matctx,&Dfine);
